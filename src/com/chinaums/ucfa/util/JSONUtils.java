...
public class JSONUtils {
    ...
    private static boolean isPrintException = false;
    ...
    public static Long getLong(JSONObject jsonObject, String key, Long defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getLong msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static Integer getInt(String jsonData, String key, Integer defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getInt msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static Double getDouble(JSONObject jsonObject, String key, Double defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getDouble msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static String getString(JSONObject jsonObject, String key, String defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getString msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static String[] getStringArray(JSONObject jsonObject, String key, String[] defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getStringArray msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static List<String> getStringList(JSONObject jsonObject, String key, List<String> defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getStringList msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static JSONObject getJSONObject(JSONObject jsonObject, String key, JSONObject defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getJSONObject msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static JSONObject getJSONObjectCascade(String jsonData, JSONObject defaultValue, String... keyArray) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getJSONObjectCascade msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static JSONArray getJSONArray(JSONObject jsonObject, String key, JSONArray defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getJSONArray msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static boolean getBoolean(JSONObject jsonObject, String key, Boolean defaultValue) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getBoolean msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return defaultValue;
    ...
    public static Map<String, String> getMap(String jsonData, String key) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.getMap msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return null;
    ...
    public static Map<String, String> parseKeyAndValueToMap(String source) {
        ...
        try {
        	...
        	MyLog.e("JSONUtils.parseKeyAndValueToMap msg=" + e.getMessage());
            if (isPrintException) {
                e.printStackTrace();
            }
            return null;
